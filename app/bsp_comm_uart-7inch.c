...
#define DEVICE_TYPE           0x04         // 0x05：5寸屏；0x04：7寸屏,0x06: new5寸屏  2022-12-09
#define VERSION               0x02         // 版本号: a.b.c; a:[bit7-bit6], b:[bit5-bit4], c:[bit3-bit0]
										//2022-12-09 VERSION-->2
...
void StartCommTask(void *argument)
{
    ...
    {
        // 获取信号量
        if (xSemaphoreTake(s_user_cli_info.sem, (TickType_t)300) == pdTRUE)
        {
            // 判断接收buf是否为空
